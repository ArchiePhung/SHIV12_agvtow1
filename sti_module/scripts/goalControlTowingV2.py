    ...
    def run(self):
        ...
        while not self.shutdown_flag.is_set(): 
            ...
            if self.datalistPointRequestMoveNow.enable == 0:
                ...
                self.pub_status(self.target_x, self.target_y, self.target_z, self.datalistPointRequestMoveNow.enable,0,0,0,0,0,0.)
                ...
                self.pub_status(self.target_x, self.target_y, self.target_z, self.datalistPointRequestMoveNow.enable,self.process,0,self.warnAGV,self.completed_all,self.infoPathFollow.pathID, self.path_error)   

            elif self.datalistPointRequestMoveNow.enable == 2:
                self.fieldRequest.data = self.infoGoalNearest.fieldSafety
                self.pub_status(self.target_x, self.target_y, self.target_z, self.datalistPointRequestMoveNow.enable,self.process,0,self.warnAGV,self.completed_backward,0, 0.)   
