...
class fakePlan():
    def __init__(self):
        ...
        path.pointSecond = Pose()
        path.pointSecond.position.x = -0.389
        path.pointSecond.position.y = 3.142
        path.velocity = 0.15
        path.numberPts = 150
        path.movableZone = 1.2
        path.pointMid = Pose()
        path.pointMid.position.x = -0.389
        ...
        path.direction = 1
        path.pointOne = Pose()
        path.pointOne.position.x = -0.389
        path.pointOne.position.y = 3.142
        path.pointSecond = Pose()
        path.pointSecond.position.x = -0.43
        path.pointSecond.position.y = 6.594
        path.velocity = 0.2
        path.movableZone = 1.2
        path.fieldSafety = 2
        self.QT1_4.pathInfo.append(path)
        ...
        # path.direction = 1
        # path.pointOne = Pose()
        # path.pointOne.position.x = -0.4
        # path.pointOne.position.y = 5.264
        # path.pointSecond = Pose()
        # path.pointSecond.position.x =-0.4
        ...
        path.direction = 1
        path.pointOne = Pose()
        path.pointOne.position.x = -0.43
        path.pointOne.position.y = 6.594
        path.pointSecond = Pose()
        path.pointSecond.position.x = -0.45
        ...
        path.pointSecond = Pose()
        path.pointSecond.position.x = -0.55
        ...
        path.direction = 1
        path.pointOne = Pose()
        path.pointOne.position.x = -0.55
        path.pointOne.position.y = 19.483
        path.pointSecond = Pose()
        path.pointSecond.position.x = -0.56
        ...
        path.direction = 1
        path.pointOne = Pose()
        path.pointOne.position.x = -0.56
        path.pointOne.position.y = 20.529
        path.pointSecond = Pose()
        path.pointSecond.position.x = -0.58
